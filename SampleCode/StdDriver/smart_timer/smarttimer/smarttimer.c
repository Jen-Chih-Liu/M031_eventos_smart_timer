...
static volatile struct stim_event event_pool[STIM_EVENT_MAX_SIZE];
static volatile struct stim_event_list_manager list_manager;
static volatile struct stim_event_list recycle_list;
